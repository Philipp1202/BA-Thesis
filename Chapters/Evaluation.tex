...
\begin{figure}[H]
    ...
    \makebox[\textwidth][c]{
        \centering
        \subbottom[Not immediately corrected words' characters\label{fig:error_user:error_user1}]{\includegraphics[width=0.5\textwidth]{user_error3_12.pdf}}
        \subbottom[Not immediately corrected words\label{fig:error_user:error_user2}]{\includegraphics[width=0.5\textwidth]{user_error3_34.pdf}}
    }
